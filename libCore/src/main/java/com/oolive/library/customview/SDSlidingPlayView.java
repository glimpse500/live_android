package com.oolive.library.customview;
...
import com.oolive.library.customview.SDViewPager.MeasureMode;
import com.oolive.library.utils.SDResourcesUtil;
import com.oolive.library.utils.SDTimer;
...
public class SDSlidingPlayView extends LinearLayout
{
    ...
    private void startPlayAuto()
    {
        ...
        isPlaying = true;
        timer.startWork(playSpan, playSpan, new SDTimer.SDTimerListener()
        {
