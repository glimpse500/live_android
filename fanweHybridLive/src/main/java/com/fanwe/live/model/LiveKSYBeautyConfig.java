...
public class LiveKSYBeautyConfig implements Serializable {
    ...
    public static LiveKSYBeautyConfig get() {
        LiveKSYBeautyConfig config = SDDisk.open().getSerializable(LiveKSYBeautyConfig.class);
        if (config == null) {
    ...
    public void setListFilter(ArrayList<LiveKSYBeautyFilterModel> listFilter) {
