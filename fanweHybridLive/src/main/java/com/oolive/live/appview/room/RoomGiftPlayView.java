...
import com.oolive.live.appview.ILiveGiftView;
import com.oolive.live.model.custommsg.CustomMsgGift;
import com.oolive.live.model.custommsg.ILiveGiftMsg;
import com.oolive.live.model.custommsg.MsgModel;
import com.oolive.live.view.LiveGiftPlayView;
...
public class RoomGiftPlayView extends RoomView {
    ...
    public void onMsgAuction(MsgModel msg) {
        ...
        if (LiveConstant.CustomMsgType.MSG_AUCTION_OFFER == msg.getCustomMsgType()) {
