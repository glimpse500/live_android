...
import com.oolive.live.adapter.LiveTabHotAdapter;
import com.oolive.live.appview.LiveTabHotHeaderView;
...
import com.oolive.live.model.LiveBannerModel;
    ...
    private void requestData() {
        CommonInterface.requestIndex(1, mSex, 0, mCity, new AppRequestCallback<Index_indexActModel>() {
            ...
            protected void onSuccess(SDResponse resp) {
                LogUtil.i("requestData Hot onSuccess");
                LogUtil.i("requestData Hot " + resp.getResult());
                if (actModel.isOk()) {
