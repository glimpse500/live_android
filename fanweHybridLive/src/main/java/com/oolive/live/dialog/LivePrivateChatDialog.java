...
import com.oolive.library.listener.SDSizeChangedCallback;
import com.oolive.library.utils.SDViewSizeListener;
...
public class LivePrivateChatDialog extends LiveBaseDialog {
    ...
    public LivePrivateChatDialog(Activity activity, String user_id) {
        ...
        mChatView.setClickListener(new LivePrivateChatView.ClickListener() {
