...
import com.oolive.live.activity.room.LiveKSYPushCreaterActivity;
import com.oolive.live.activity.room.LivePlaybackActivity;
...
public class AppRuntimeWorker {
    ...
    public static int getIsShowViewerPlugs() {
        return SDResourcesUtil.getResources().getInteger(R.integer.is_viewer_show_plug);
    }
    ...
    public static boolean getIsOpenWebviewMain() {
        return SDResourcesUtil.getResources().getBoolean(R.bool.is_open_webview_main);
    }
