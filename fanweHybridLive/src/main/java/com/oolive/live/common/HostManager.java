...
import com.oolive.library.listener.SDResultCallback;
import com.oolive.library.receiver.SDNetworkReceiver;
import com.oolive.library.utils.IOUtil;
    ...
    private static class HostModel {
        ...
        public static HostModel get() {
            try {
                ...
                LogUtil.i("current versionCode" + SDPackageUtil.getVersionCode());
                LogUtil.i("Model versionCode" + model.getVersionCode());
                if (SDPackageUtil.getVersionCode() > model.getVersionCode() || ApkConstant.FORCE_UPDATE) {
                    //app升级或者第一次安装
